 ...
 */
public class NewBloomFilter<E> implements Serializable {
    ...
    /**
      ...
      */
    public NewBloomFilter(double c, int n, int k) {
     ...
     */
    public NewBloomFilter(int bitSetSize, int expectedNumberOElements) {
     ...
     */
    public NewBloomFilter(double falsePositiveProbability, int expectedNumberOfElements) {
     ...
     */
    public NewBloomFilter(int bitSetSize, int expectedNumberOfFilterElements, int actualNumberOfFilterElements, BitSet filterData) {
    ...
    public boolean equals(Object obj) {
        ...
        final NewBloomFilter<E> other = (NewBloomFilter<E>) obj;        
